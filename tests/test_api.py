...
class TestCreateGrid:
    ...
    def test_create_grid_with_bound_box(self, sample_voxel_resolution, sample_bound_box):
    ...
    def test_create_grid_with_path_vectors(self, sample_voxel_resolution, sample_path_vectors):
...
class TestCreatePathVectors:
    ...
    def test_create_path_vectors_basic(self, sample_bound_box, sample_process_parameters):
    ...
    def test_create_path_vectors_single_layer(self, sample_bound_box, sample_process_parameters):
    ...
    def test_create_path_vectors_multiple_layers(self, sample_bound_box, sample_process_parameters):
    ...
    def test_create_path_vectors_rotation(self, sample_bound_box, sample_process_parameters):
        """Test path vector generation with rotation."""
        # TODO: Test different rotation angles
        pass
    
    def test_create_path_vectors_hatch_spacing(self, sample_bound_box, sample_process_parameters):
